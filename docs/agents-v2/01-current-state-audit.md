...
> **Исторический снимок на 2026-07-06; не текущая приёмочная база.**
> Наблюдения и выводы ниже сохранены без переписывания. Их supersede'ит
> [полный аудит 2026-07-21](../audit/full-project-audit-2026-07-21.md),
> включая решение **NO-GO** и актуальный runtime-контракт.
